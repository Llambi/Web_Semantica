...
class TestCoefs(unittest.TestCase):
    """
    Se han realizado cambios, las lineas comentadas son las dadas en la practica y a continuacion estaras mis cambios
    """
    ...
    def test_coef_dice(self):
        ...
        self.assertAlmostEqual(DiceStrategy(bag1, bag2).exec(), 0.5)
    ...
    def test_coef_jaccard(self):
        ...
        self.assertAlmostEqual(JaccardStrategy(bag1, bag2).exec(), 0.333, places=3)
    ...
    def test_coef_cosine(self):
        ...
        self.assertAlmostEqual(CosineStrategy(bag1, bag2).exec(), 0.125)
    ...
    def test_coef_overlapping(self):
        ...
        self.assertAlmostEqual(OverlappingStrategy(bag1, bag2).exec(), 0.5)
