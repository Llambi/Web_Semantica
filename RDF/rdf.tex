...
%\lstinputlisting[language=XML, firstline=1, lastline=25, breaklines, caption={Archivo RDF con la información estructurada del texto 1.}]{resources/OpenCalais/OpenCalaisText1.rdf}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 2.}]{resources/OpenCalais/OpenCalaisText2.rdf}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 3.}]{resources/OpenCalais/OpenCalaisText3.rdf}

\subsubsection{DBPedia-Spotlight}\label{DBPediaRDF}
\subsubsection{FRED}\label{FREDRDF}
%\lstinputlisting[language=XML, firstline=1, lastline=25, breaklines, caption={Archivo RDF con la información estructurada del texto 1.}]{resources/Fred/FredText1.rdf}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 2.}]{resources/Fred/FredText2.rdf}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 3.}]{resources/Fred/FredText3.rdf}

\subsection{Archivos Turtle producidos por herramientas}

\subsubsection{Open Calais}\label{OpenCalaisTurtle}
%\lstinputlisting[language=XML, firstline=1, lastline=25, breaklines, caption={Archivo RDF con la información estructurada del texto 1.}]{resources/OpenCalais/OpenCalaisText1.ttl}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 2.}]{resources/OpenCalais/OpenCalaisText2.ttl}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 3.}]{resources/OpenCalais/OpenCalaisText3.ttl}

\subsubsection{DBPedia-Spotlight}\label{DBPediaTurtle}
\subsubsection{FRED}\label{FREDTurtle}
%\lstinputlisting[language=XML, firstline=1, lastline=25, breaklines, caption={Archivo RDF con la información estructurada del texto 1.}]{resources/Fred/FredText1.ttl}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 2.}]{resources/Fred/FredText2.ttl}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 3.}]{resources/Fred/FredText3.ttl}

\subsection{Archivos JSONLD producidos por herramientas}

\subsubsection{Open Calais}\label{OpenCalaisJSON}
%\lstinputlisting[language=XML, firstline=1, lastline=25, breaklines, caption={Archivo RDF con la información estructurada del texto 1.}]{resources/OpenCalais/OpenCalaisText1.json}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 2.}]{resources/OpenCalais/OpenCalaisText2.json}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 3.}]{resources/OpenCalais/OpenCalaisText3.json}

\subsubsection{DBPedia-Spotlight}\label{DBPediaJSON}
\subsubsection{FRED}\label{FREDJSON}
%\lstinputlisting[language=XML, firstline=1, lastline=25, breaklines, caption={Archivo RDF con la información estructurada del texto 1.}]{resources/Fred/FredText1.json}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 2.}]{resources/Fred/FredText2.json}
%\lstinputlisting[language=XML, lastline=50, breaklines, caption={Archivo RDF con la información estructurada del texto 3.}]{resources/Fred/FredText3.json}
